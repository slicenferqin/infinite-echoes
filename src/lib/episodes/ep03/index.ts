...
export const episode03: EpisodeConfig = {
  ...
  name: '第七天配给',
  description:
    '第七层配给城运行得过于平稳，也因此显得更冷。余岚被系统判定失去抚养资格，孩子药配同步中断。你有七天时间，去判断这座高压文明该继续靠删减活着，还是把一部分选择权还给人。',
  difficulty: 3,
  maxRounds: 60,
...
- 审理窗口将在第七天傍晚自动闭合`,
  ...
  culturalProfile: {
    valueCore: ['养育责任', '集体生存与个体完整性', '秩序正当性与人的自由'],
...
这里太顺了。
路面干净，播报稳定，配给屏上的数字精确得让人几乎安心。
也正因为太合理，才显得更冷。

屏幕反复播报“秩序稳定”，而你面前的女人却抱着药配断档单，声音发抖又硬：
“系统说我不配继续养他。可他连生日口令都只认我一个人。”

阿寂从人群后走出来，低声说：
“欢迎来到第七层。这里每个正确答案，都有人要先付代价。”

你很快发现，这里真正被审理的，从来不只是余岚的资格，而是一个文明还愿不愿意把人完整地保留下来。`,
...
你最终提交的不会只是案件答案，还会是这座城市准备靠什么继续活下去：
• 继续让系统主导稳定
• 让人类拿回更高代价的选择权
• 或承认只有极少数人能背负全部真相
