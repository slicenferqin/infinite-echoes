...
export const episode01: EpisodeConfig = {
  id: 'ep01',
  name: '沉默的铁匠铺',
  description: '鸦石村，一个行商死在铁匠铺门前。铁匠被捕，却一言不发。执法官明日抵达。你只有一天的时间。',
  difficulty: 1,
  maxRounds: 30,
...
一个灰扑扑的小村庄嵌在山谷里，石头房子层层叠叠。空气中带着铁锈和松木的气味。

还没走到村口的石桥，一个十六七岁的少女就冲了过来，几乎撞到你身上。她的眼睛红肿，声音沙哑：

"你……你是外面来的人吗？求求你，帮帮我父亲！他没有杀人！他们把他关起来了，明天执法官就到了，他会死的！没有人愿意帮我们……求你了……"

少女叫诺拉，她的父亲是村里的铁匠汉克。三天前，一个名叫费恩的行商被发现死在铁匠铺门前，胸口插着一把铁匠锻造的短刀。汉克被当场抓获——他跪在尸体旁，双手沾满鲜血，却一言不发。

村长艾德蒙宣布：领主的执法官明日午时抵达。届时将对汉克执行审判。`,
